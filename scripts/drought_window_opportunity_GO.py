...
SRNA = {
    100: ROOT / "drought_consensus/results/drought_24nt_100bp_matrix.tsv",
    500: ROOT / "drought_consensus/results/drought_24nt_500bp_matrix.tsv",
}

METH = {
    ("CG",100):  ROOT / "drought_consensus/results/drought_CG_100bp_matrix.tsv",
    ("CG",500):  ROOT / "drought_consensus/results/drought_CG_500bp_matrix.tsv",
    ("CHG",100): ROOT / "drought_consensus/results/drought_CHG_100bp_matrix.tsv",
    ("CHG",500): ROOT / "drought_consensus/results/drought_CHG_500bp_matrix.tsv",
    ("CHH",100): ROOT / "drought_consensus/results/drought_CHH_100bp_matrix.tsv",
    ("CHH",500): ROOT / "drought_consensus/results/drought_CHH_500bp_matrix.tsv",
}
...
cache = OUT / f"drought_window_opportunity_cache_{args.feature}"
cache.mkdir(exist_ok=True)

genome_file = cache / "drought_chrom_sizes.txt"
...
outfile = OUT / (
    f"drought_{args.feature}_window_opportunity_GO_"
