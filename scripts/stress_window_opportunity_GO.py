...
print(f"Joint-tail threshold: {args.tail:g}%", flush=True)
...
cache = OUT / f"heat_window_opportunity_cache_{args.feature}"
...
# ============================================================
# Observed joint-tail candidate windows
# ============================================================
...
outfile = OUT / (
    f"heat_{args.feature}_window_opportunity_GO_"
